package com.github.sadeemhup.system;



import com.github.sadeemhup.system.core.DataBase.DataBaseConfig;
...
public class boot extends AbstractVerticle {
    ...
    public static void main(String[] args) {
        ...
        vertx.deployVerticle("com.github.sadeemhup.system.Luncher", new DeploymentOptions().setWorker(true).setWorkerPoolSize(100).setInstances(4));
